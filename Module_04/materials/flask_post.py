"""
Этот код демонстрирует гибкость Flask 
в обработке различных форматов данных, передаваемых в теле 
POST-запроса, и может быть полезным при работе с различными клиентами, 
которые могут отправлять данные в различных форматах.
"""
